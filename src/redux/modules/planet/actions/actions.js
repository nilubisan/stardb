import {CHANGE_CURRENT_PLANETS_PAGE_NUMBER, LOAD_PLANETS_REQUEST, LOAD_PLANETS_SUCCESS, LOAD_PLANETS_FAILURE, FETCH_PLANETS_BY_PAGE_NUMBER_REQUEST} from './actionTypes';
