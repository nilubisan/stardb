import {CHANGE_CURRENT_PERSONS_PAGE_NUMBER, LOAD_PERSONS_REQUEST, LOAD_PERSONS_SUCCESS, LOAD_PERSONS_FAILURE, FETCH_PERSONS_BY_PAGE_NUMBER_REQUEST, LOAD_PERSON_SUCCESS} from './actionTypes';

export const changeCurrentPersonsPageNumber = (pageNumber) => ({type: CHANGE_CURRENT_PERSONS_PAGE_NUMBER, pageNumber});
